...
<!-- main content start -->
    ...
    <nav class="breadcrumb-section breadcrumb-chairs">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="bread-crumb-title">Chairs</h2>
                            ...
                            <div class="row grid-view mb-n5">
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                                    <div class="product-card">
                                        <a href="#" class="product-thumb hover-zoom"> 
                                            <img height="250px" width="150px" src="{{asset('/images/chairs/chair 1.png')}}" alt="image_not_found">
                                        </a>
                                        <!-- thumb end -->
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                                    <div class="product-card">
                                        <a href="#" class="product-thumb"> 
                                            <img height="250px" width="150px" src="{{asset('/images/chairs/chair 2.png')}}" alt="image_not_found">
                                        </a>
                                        <!-- thumb end -->
                                        <div class="product-content">
                                            <h4><a href="/contact-us" class="product-title">Contact For More Details</a></h4>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                                    <div class="product-card">
                                        <a href="#" class="product-thumb"> 
                                            <img height="250px" width="150px" src="{{asset('/images/chairs/chair 3.jpg')}}" alt="image_not_found">
                                        </a>
                                        <!-- thumb end -->
                                        <div class="product-content">
                                            <h4><a href="/contact-us" class="product-title">Contact For More Details</a></h4>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                                    <div class="product-card">
                                        <a href="#" class="product-thumb"> 
                                            <img height="250px" width="150px" src="{{asset('/images/chairs/chair 5.jpg')}}" alt="image_not_found">
                                        </a>
                                        <!-- thumb end -->
                                        <div class="product-content">
                                            <h4><a href="/contact-us" class="product-title">Contact For More Details</a></h4>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                                    <div class="product-card">
                                        <a href="#" class="product-thumb"> 
                                            <img height="250px" width="150px" src="{{asset('/images/chairs/chair 6.jpg')}}" alt="image_not_found">
                                        </a>
                                        <!-- thumb end -->
                                        <div class="product-content">
                                            <h4><a href="/contact-us" class="product-title">Contact For More Details</a></h4>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                                    <div class="product-card">
                                        <a href="#" class="product-thumb"> 
                                            <img height="250px" width="150px" src="{{asset('/images/chairs/chair 4.jpg')}}" alt="image_not_found">
                                        </a>
                                        <!-- thumb end -->
                                        <div class="product-content">
                                            <h4><a href="/contact-us" class="product-title">Contact For More Details</a></h4>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                                    <div class="product-card">
                                        <a href="#" class="product-thumb"> 
                                            <img height="250px" width="150px" src="{{asset('/images/chairs/table & chair 2.jpg')}}" alt="image_not_found">
                                        </a>
                                        <!-- thumb end -->
                                        <div class="product-content">
                                            <h4><a href="/contact-us" class="product-title">Contact For More Details</a></h4>
