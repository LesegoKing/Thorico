...
<!-- main content start -->
    ...
    <nav class="breadcrumb-section breadcrumb-tables">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="bread-crumb-title">Outdoor Tables</h2>
                    <ol class="breadcrumb bg-transparent m-0 p-0 justify-content-center align-items-center">
                        <li class="breadcrumb-item"><a href="/shop">Shop</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Outdoor Tables</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel">
                            <div class="row grid-view mb-n5">
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                                    <div class="product-card">
                                        <a href="#" class="product-thumb"> 
                                            <img height="235px" width="" src="{{asset('/images/tables/tables 2.png')}}" alt="image_not_found">
                                        </a>
                                        <!-- thumb end -->
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                                    <div class="product-card">
                                        <a href="#" class="product-thumb"> 
                                            <img height="235px" width="" src="{{asset('/images/tables/tables 4.jpg')}}" alt="image_not_found">
                                        </a>
                                        <!-- thumb end -->
                                        <div class="product-content">
                                            <h4><a href="/contact-us" class="product-title">Contact For More Details</a></h4>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                                    <div class="product-card">
                                        <a href="#" class="product-thumb"> 
                                            <img height="235px" width="" src="{{asset('/images/tables/tables 5.jpg')}}" alt="image_not_found">
                                        </a>
                                        <!-- thumb end -->
                                        <div class="product-content">
                                            <h4><a href="/contact-us" class="product-title">Contact For More Details</a></h4>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                                    <div class="product-card">
                                        <a href="#" class="product-thumb"> 
                                            <img height="235px" width="" src="{{asset('/images/tables/tables 3.jpg')}}" alt="image_not_found">
                                        </a>
                                        <!-- thumb end -->
                                        <div class="product-content">
                                            <h4><a href="/contact-us" class="product-title">Contact For More Details</a></h4>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-5">
                                    <div class="product-card">
                                        <a href="#" class="product-thumb"> 
                                            <img height="235px" width="" src="{{asset('/images/tables/tables 1.png')}}" alt="image_not_found">
                                        </a>
                                        <!-- thumb end -->
                                        <div class="product-content">
                                            <h4><a href="/contact-us" class="product-title">Contact For More Details</a></h4>
